...
export default function AppbarIcon1({ svgRef, ...props }: Props) {
  return (
    <SvgIcon
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <path
        ...
        stroke="url(#paint0_linear_20726_559)"
        stroke-width="2.7"
      ...
      <path
        ...
        stroke="url(#paint1_linear_20726_559)"
        stroke-width="2.7"
        stroke-miterlimit="10"
      />
      <path
        ...
        fill="url(#paint2_linear_20726_559)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_20726_559"
          x1="2.89818"
          y1="8.44539"
          x2="18.1055"
          y2="8.44539"
